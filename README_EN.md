...
A Minecraft Forge 1.20.1 mod that depends on Create Mod 0.5.1+ (supports 0.5.1j and 6.0.x versions). Automatically generates Create-style railway networks during world generation, including bridges, tunnels, and stations.
...
2. Download and install [Create Mod 0.5.1+](https://www.curseforge.com/minecraft/mc-mods/create) (supports 0.5.1j and 6.0.x versions)
